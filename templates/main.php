        ...
        <ul class="promo__list">
            ...
            <?php foreach ($lot_categories as $value) { ?>
                <li class="promo__item promo__item--boards">
                    <a class="promo__link" href="pages/all-lots.html"><?php print(strip_tags($value)) ?></a>
                </li>
            <?php } ?>
        </ul>
    </section>
        ...
        <ul class="lots__list">
            ...
            <?php foreach ($lots as $key => $value) { ?>
                <li class="lots__item lot">
                    ...
                    <div class="lot__info">
                        <span class="lot__category"><?php print(strip_tags($lot_categories[$value['category']])) ?></span>
