...
<head>
  <meta charset="UTF-8">
  <title><?php print($lot[0]["name"]) ?></title>
      ...
      <div class="lot-item__content">
        ...
        <div class="lot-item__right">
          <div class="lot-item__state">
            <div class="lot-item__timer <?php if (get_dt_range($value['date_create'])[0] == '00') print(' timer--finishing'); ?> timer">
              <?php print(get_dt_range($lot[0]["date_create"])[0].':'.get_dt_range($lot[0]["date_close"])[1]) ?>
            </div>
            <div class="lot-item__cost-state">
              <div class="lot-item__rate">
                <span class="lot-item__amount">Текущая цена</span>
                <span class="lot-item__cost"><?php print(intval($lot[0]["price_start"])); ?></span>
              </div>
              <div class="lot-item__min-cost">
                Мин. ставка <span><?php print(intval($lot[0]["price_start"])+intval($lot[0]["price_step"])." p") ?></span>
              </div>
            </div>
